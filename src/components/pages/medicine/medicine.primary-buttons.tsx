...
import { FileDown, FileSpreadsheet, FileUp, MoreHorizontal, PlusCircle } from "lucide-react";
import { motion } from 'motion/react';

export function MedicinePrimaryButtons() {
  const { setOpen } = useMedicineDialog();
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      >
        <Button
          className="gap-2 bg-gradient-to-r from-fuchsia-500 to-fuchsia-600 hover:from-fuchsia-600 hover:to-fuchsia-700 text-white shadow-md border-0 font-medium px-4 py-2.5 h-auto rounded-lg transition-all duration-200"
          onClick={() => setOpen("add")}
        >
