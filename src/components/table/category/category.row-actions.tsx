      ...
      <DropdownMenu modal={false}>
        <DropdownMenuTrigger asChild>
          <Button
            variant="ghost"
            size="icon"
            className="h-8 w-8 p-0 text-slate-500 hover:text-amber-600 dark:text-slate-400 dark:hover:text-amber-400 hover:bg-amber-50 dark:hover:bg-amber-900/20 rounded-full data-[state=open]:bg-amber-50 dark:data-[state=open]:bg-amber-900/20 data-[state=open]:text-amber-600 dark:data-[state=open]:text-amber-400"
          >
