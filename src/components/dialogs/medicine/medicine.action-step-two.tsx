...
import { Calculator, Package, Tag, Tags, Warehouse } from "lucide-react";
import { useEffect } from "react";
import { UseFormReturn } from "react-hook-form";

interface MedicineActionStepTwoProps {
  form: UseFormReturn<MedicineSchema>
}

export function MedicineActionStepTwo({ form }: MedicineActionStepTwoProps) {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 pb-2 mb-2 border-b border-fuchsia-100">
        <Tags className="h-5 w-5 text-fuchsia-600" />
        <h3 className="text-lg font-medium text-fuchsia-800">Giá và trạng thái</h3>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <motion.div whileHover={{ scale: 1.01 }} className="transition-all duration-200">
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="transition-all duration-200 hover:bg-fuchsia-50/50 p-3 rounded-lg">
                <FormLabel className="text-fuchsia-700 font-medium flex items-center gap-1">
                ...
                <FormControl>
                  <Input
                    ...
                    className="border-fuchsia-200 focus:border-fuchsia-400 focus:ring-fuchsia-200"
                  />
                </FormControl>
            ...
            <FormItem className="transition-all duration-200 p-3 rounded-lg">
              ...
              <FormControl>
                <Input
                  ...
                  {...field}
                  readOnly
                  className="bg-fuchsia-50/50 border-fuchsia-200 text-fuchsia-800 font-medium"
                />
              </FormControl>
              <FormMessage className="text-red-500" />
            </FormItem>
      ...
      <motion.div whileHover={{ scale: 1.01 }} className="transition-all duration-200">
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="transition-all duration-200 hover:bg-fuchsia-50/50 p-3 rounded-lg">
              <FormLabel className="text-fuchsia-700 font-medium">Trạng thái kho</FormLabel>
              <Select
                onValueChange={field.onChange}
                defaultValue={field.value}
              >
                <FormControl>
                  <SelectTrigger className="border-fuchsia-200 focus:border-fuchsia-400 focus:ring-fuchsia-200">
      ...
      <motion.div
        ...
        className="p-5 bg-gradient-to-r from-fuchsia-50 to-pink-50 rounded-lg shadow-sm border border-fuchsia-100"
      >
        <h4 className="text-fuchsia-800 font-medium mb-4 pb-2 border-b border-fuchsia-100">Tùy chọn hiển thị</h4>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="flex items-center space-x-3 bg-white/80 p-3 rounded-lg">
                ...
                <div>
                  <FormLabel className="text-fuchsia-700 font-medium">Sản phẩm nổi bật</FormLabel>
                  <p className="text-xs text-fuchsia-500">Hiển thị trên trang chủ và các mục đề xuất</p>
                </div>
              </FormItem>
            )}
          />
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="flex items-center space-x-3 bg-white/80 p-3 rounded-lg">
                ...
                <div>
                  <FormLabel className="text-fuchsia-700 font-medium">Sản phẩm kích hoạt</FormLabel>
                  <p className="text-xs text-fuchsia-500">Hiển thị sản phẩm cho khách hàng</p>
                </div>
              </FormItem>
            )}
          />
