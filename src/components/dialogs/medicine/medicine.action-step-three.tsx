...
interface MedicineActionStepThreeProps {
  form: UseFormReturn<MedicineSchema>
}

export function MedicineActionStepThree({ form }: MedicineActionStepThreeProps) {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 pb-2 mb-2 border-b border-fuchsia-100">
        ...
        <h3 className="text-lg font-medium text-fuchsia-800">Thông tin chi tiết</h3>
      </div>
            ...
            <FormItem className="transition-all duration-200 hover:bg-fuchsia-50/50 p-3 rounded-lg">
              ...
              <FormControl>
                <Textarea
                  ...
                  className="min-h-32 border-fuchsia-200 focus:border-fuchsia-400 focus:ring-fuchsia-200"
                  {...field}
                />
              </FormControl>
      ...
      <motion.div 
        ...
        className="bg-gradient-to-r from-fuchsia-50/80 to-pink-50/80 p-5 rounded-lg shadow-sm border border-fuchsia-100"
      >
        ...
        <div className="space-y-2">
                  ...
                  <FormItem className="flex-1">
                    <FormControl>
                      <Input 
                        ...
                        {...field} 
                        className="border-fuchsia-200 focus:border-fuchsia-400 focus:ring-fuchsia-200 bg-white/90"
                      />
                    </FormControl>
                    <FormMessage className="text-red-500" />
                  </FormItem>
          ...
          <Button
            ...
            className="mt-2 bg-white/80 border-fuchsia-200 text-fuchsia-600 hover:bg-fuchsia-50 hover:border-fuchsia-400"
          >
            + Thêm cách sử dụng
          </Button>
        </div>
