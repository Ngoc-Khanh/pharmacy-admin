...
interface MedicineActionStepFourProps {
  form: UseFormReturn<MedicineSchema>
}

export function MedicineActionStepFour({ form }: MedicineActionStepFourProps) {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 pb-2 mb-2 border-b border-fuchsia-100">
        <PenLine className="h-5 w-5 text-fuchsia-600" />
        <h3 className="text-lg font-medium text-fuchsia-800">Hướng dẫn sử dụng thuốc</h3>
      </div>

      <motion.div 
        whileHover={{ scale: 1.01 }} 
        className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-gradient-to-r from-fuchsia-50/80 to-pink-50/80 p-5 rounded-lg shadow-sm border border-fuchsia-100"
      >
        <FormField
      ...
      <motion.div 
        whileHover={{ scale: 1.01 }} 
        className="p-5 bg-gradient-to-r from-amber-50/80 to-fuchsia-50/80 rounded-lg shadow-sm border border-amber-100"
      >
