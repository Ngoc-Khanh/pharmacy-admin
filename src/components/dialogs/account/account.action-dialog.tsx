...
import { Eye, EyeOff, KeyRound, LockKeyhole, Mail, Phone, RefreshCw, ShieldCheck, Sparkles, ToggleLeft, UserCircle, UserIcon } from "lucide-react"
                      ...
                      <FormItem className="space-y-1.5">
                        ...
                        <Select onValueChange={field.onChange} defaultValue={field.value}>
                          ...
                          <SelectContent className="border border-emerald-200/10">
                            ...
                            <SelectItem value={AccountStatus.PENDING}>
                              <div className="flex items-center gap-2">
                          ...
                          <FormControl className="flex-1">
                            <div className="relative group">
                              ...
                              <Button
                                ...
                                variant="ghost"
                                size="sm"
                                className="absolute right-1 top-1/2 h-7 w-7 -translate-y-1/2 hover:bg-emerald-100/50 dark:hover:bg-emerald-900/20"
