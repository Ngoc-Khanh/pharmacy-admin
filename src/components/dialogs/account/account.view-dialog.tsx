...
export const ViewAccountSheet = memo(function ViewAccountSheet({ currentAccount, open, onOpenChange }: Props) {
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent className="w-[400px] sm:w-[600px] max-w-[90vw] overflow-hidden p-0">
        <div className="flex flex-col h-full">
          ...
          <div className="relative overflow-hidden">
            ...
            <div className="relative p-6">
              ...
              <motion.div
                ...
                className="flex flex-col items-start mt-6 gap-4"
              >
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100">{`${currentAccount.firstname} ${currentAccount.lastname}`}</h3>
                  <p className="text-sm text-muted-foreground mb-3">@{currentAccount.username}</p>
                  <div className="flex flex-wrap items-center gap-2">
                    <Badge variant="outline" className={`px-3 py-1 text-xs ${statusBadge.className}`}>
                      {statusBadge.label}
                    </Badge>
                    <Badge variant="outline" className={`px-3 py-1 text-xs flex items-center gap-1.5 ${roleBadge.className}`}>
          ...
          {/* Chi tiết người dùng - có thể scroll */}
          <motion.div
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-base font-medium">{currentAccount.email}</p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-base font-medium">{currentAccount.phone || "—"}</p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="flex flex-col gap-3 flex-1">
                  <div>
                    ...
                    <p className="text-base font-medium">@{currentAccount.username}</p>
                  </div>
                  <div>
                    <p className="text-sm font-medium text-muted-foreground mb-1">Vai trò</p>
                    <Badge variant="outline" className={`px-2 py-[2px] text-xs flex items-center gap-1.5 w-fit ${roleBadge.className}`}>
                      <RoleIcon className="h-3 w-3" />
                      {roleBadge.label}
                    </Badge>
                  </div>
